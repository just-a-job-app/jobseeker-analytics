...
# LLM provider selection - default to gemini which is already installed
LLM_PROVIDER = os.getenv("LLM_PROVIDER", "gemini").lower()  # claude, openai, or gemini

# Import modules based on provider - lazy loading to avoid import errors
