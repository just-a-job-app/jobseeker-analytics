	...
	return (
		<main className="container mx-auto px-4 py-8 max-w-4xl text-gray-800 dark:text-gray-200">
			...
			<section className="mb-8">
				<p className="mb-4">
					This Cookie Policy explains how <strong>JustAJobApp LLC</strong> uses cookies and similar
					...
					. It explains what these technologies are, why we use them, and your rights to control our use of
					them.
				</p>
			</section>
			...
			<p className="mb-4 text-sm">We use first-party and third-party cookies for several reasons:</p>
			<ul className="list-disc list-inside space-y-2 ml-4 text-sm mb-6">
				<li>
					<strong>Essential cookies:</strong> Required for technical reasons to operate our website and
					provide core functionality.
				</li>
				<li>
					<strong>Analytics cookies:</strong> Enable us to understand how users interact with our site (via
					PostHog, which respects your consent preferences).
				</li>
				<li>
			...
			<ul className="list-disc list-inside space-y-2 ml-4 text-sm mb-6">
				<li>
					...
					<code className="bg-gray-200 dark:bg-gray-700 px-2 py-1 rounded">jaja-consent</code>
				</li>
				<li>
				...
				<li>
					<strong>Values:</strong> &quot;true&quot; (analytics enabled), &quot;false&quot; (analytics
					disabled), or absent (banner will be shown).
				</li>
				<li>
					<strong>How it works:</strong> When you first visit, a consent banner appears at the bottom of the
					page. Choose &quot;Accept&quot; to enable analytics or &quot;Decline&quot; to disable it.
				</li>
			</ul>

			<h2 className="text-2xl font-semibold mb-4 border-b pb-2">Analytics Gating with PostHog</h2>
			<p className="mb-4 text-sm">
				PostHog analytics is <strong>only initialized</strong> when the{" "}
				<code className="bg-gray-200 dark:bg-gray-700 px-2 py-1 rounded">jaja-consent</code> cookie equals
				&quot;true&quot;. If you decline consent or have not yet responded to the banner, PostHog will not track
				your activity. We also respect:
			</p>
			<ul className="list-disc list-inside space-y-2 ml-4 text-sm mb-6">
				<li>
				...
				<li>
					<strong>Do Not Track (DNT):</strong> If enabled in your browser, analytics is automatically
					disabled.
				</li>
			</ul>
			...
			<ul className="list-disc list-inside space-y-2 ml-4 text-sm mb-6">
				<li>
					<strong>ph_..._posthog:</strong> Analytics identifier (PostHog) — only set when consent is
					&quot;true&quot;
				</li>
			</ul>

			<h2 className="text-2xl font-semibold mb-4 border-b pb-2">How to Control Cookies</h2>
			<p className="mb-4 text-sm">You can control your consent preferences in two ways:</p>
			<ul className="list-disc list-inside space-y-2 ml-4 text-sm mb-6">
				<li>
					<strong>Consent Banner:</strong> Use the banner that appears at the bottom of the page. Click
					&quot;Accept&quot; or &quot;Decline&quot; to set your preference.
				</li>
				<li>
					<strong>Browser Controls:</strong> You can also manage cookies through your browser settings. Visit
